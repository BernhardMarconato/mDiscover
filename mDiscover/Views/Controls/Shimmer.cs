...
// Source: https://github.com/CommunityToolkit/Labs-Windows/blob/main/components/Shimmer/src/Shimmer/Shimmer.cs
...
public partial class Shimmer : Control
{
    ...
    private void TryStartAnimation()
    {
        ...
        var rootVisual = ElementCompositionPreview.GetElementVisual(_shape);
        _sizeAnimation = rootVisual.Compositor.CreateExpressionAnimation("rootVisual.Size");
        _sizeAnimation.SetReferenceParameter("rootVisual", rootVisual);
